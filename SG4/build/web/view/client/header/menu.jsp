        ...
        <div class="navbar navbar-default" role="navigation">
          ...
          <div class="navbar-collapse collapse">
            ...
            <ul class="nav navbar-nav">
                <li class="aa-navbar-link"><a href="${pageContext.request.contextPath}/">TRANG CHỦ</a></li>
              <li class="aa-navbar-link"><a href="${pageContext.request.contextPath}/view/client/introduce">GIỚI THIỆU</a></li>
            <li class="aa-navbar-link"><a href="${pageContext.request.contextPath}/view/client/product">SẢN PHẨM</span></a>
...
<!--              <li class="aa-navbar-link"><a href="${pageContext.request.contextPath}/view/client/news-list">TIN TỨC</a></li>-->
              <li class="aa-navbar-link"><a href="${pageContext.request.contextPath}/view/client/security">CHÍNH SÁCH</a></li>
              <li class="aa-navbar-link"><a href="${pageContext.request.contextPath}/view/client/contact">LIÊN HỆ</a></li>
