                ...
                <div class="aa-header-bottom-area">
                    ...
                    <div class="aa-shipping-box">
                        ...
                        <a class="aa-shipping-boxsmall">
                            ...
                            <span class="aa-shipping-box-text">
                                <div class="aa-shipping-title">Hỗ trợ: 012.345.6789</div>
                    ...
                    <div class="aa-cartbox">
                        <a class="aa-cart-link" href="${pageContext.request.contextPath}/view/client/cart">
                            ...
                            <c:if test="${length_order != NULL && length_order != 0}">
                                <span class="aa-cart-notify">${length_order}</span>
                            </c:if>
                        </a>
                        <div class="aa-cartbox-summary">
                            <ul class="scroll-product">
                                <c:if test="${order == null || length_order == 0}">
                                    <p>Giỏ hàng rỗng!</p>
                                </c:if>
                            ...
                            <div class="btn-checkout-cartbox">
                                <a id="btn-tocart" class="aa-cartbox-checkout aa-primary-btn" href="${pageContext.request.contextPath}/view/client/cart">Chi tiết</a>
                                <a id="btn-checkout" class="aa-cartbox-checkout aa-primary-btn" href="${pageContext.request.contextPath}/view/client/checkout">Thanh toán</a>
                            </div>       
                        </div>
                    </div>
                    <!-- / cart box -->
