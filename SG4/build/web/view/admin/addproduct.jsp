                    ...
                    <div class="card-body">
                        ...
                        <form action="${pageContext.request.contextPath}/admin/product/add" method="POST" enctype='multipart/form-data'>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="input-1" placeholder="Sản phẩm" name="product-sum">
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div>
                                    <textarea class="form-control" id="content-product" name="product-content" style="display: none"></textarea>
