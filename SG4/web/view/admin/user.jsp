                        ...
                        <div class="table-responsive">
                            <table class="table table-striped">
                             ...
                             <div class="pagination" style="align-items: center;justify-content: center">
                                ...
                                <c:if test="${tag > 1}">
                                    <a href="${pageContext.request.contextPath}/admin/user/list?index=${tag - 1}">&laquo;</a>
                                </c:if>

                                <c:forEach begin="${beginP}" end="${maxP}" var="i">
                                    <a class="${tag == i?"active" : ""}" href="${pageContext.request.contextPath}/admin/user/list?index=${i}">${i}</a>
                                </c:forEach>
                                <c:if test="${tag < maxP}">
                                    <a href="${pageContext.request.contextPath}/admin/user/list?index=${tag + 1}">&raquo;</a>
                                </c:if>
                            </div>
                        </div>
                    </div>
