                    ...
                    <div class="card-body">
                        ...
                        <form method="post" action="${pageContext.request.contextPath}/admin/product/edit">
                            ...
                            <div class="form-group">
                                ...
                                <div>
                                    <select class="form-control valid" readonly="readonly" id="input-6" name="product-status" required aria-invalid="false">
                            ...
                            <div class="form-group">
                                ...
                                <div>
                                    <textarea id="summernote" class="form-control" rows="4" id="input-17" name="product-content">${product.content}</textarea>
                                </div>
                            </div>
