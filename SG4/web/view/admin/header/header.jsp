...
<html lang="en">
    <head>
        ...
        <link rel="stylesheet" href="${url}/plugins/summernote/dist/summernote.min.css"/>
        <link rel="icon" href="${url}/images/transparent-logo.png" type="image/x-icon">
            ...
            <header class="topbar-nav">
                <nav class="navbar navbar-expand fixed-top">
                    ...
                    <ul class="navbar-nav align-items-center right-nav-link">
                        <c:forEach items="${department}" var="i">
                            <c:if test="${i.id == department_id}">
                                <li style="font-weight: bold;margin-right: 15px;display: flex;align-items: center;justify-content: center;gap: 0 10px;font-size: 17px;"></li>
                                </c:if>
                            </c:forEach>               
                        <li class="nav-item">
                                    ...
                                    <a href="javaScript:void();">
                                        <div class="media">
                                            ...
                                            <div class="media-body">
                                                <h6 class="mt-2 user-title">SG4 Store</h6>
