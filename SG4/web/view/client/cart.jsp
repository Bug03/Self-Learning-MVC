...
<!-- notify cart empty -->
<c:if test="${sessionScope.length_order == null || sessionScope.length_order == 0}">
    <section id="cart-view-empty">
            ...
            <div class="row">
                <div class="col-md-12">
                    <c:if test="${updateMessage != null}">
                        <p class="aa-checkout-success aa-cart-update"> <i class="fas fa-check-circle"></i> ${updateMessage}</p>
                    </c:if>
                                        ...
                                        <tbody>
                                            <c:forEach items="${order.items}" var="item">
                                                <tr>
                                                    ...
                                                    <td><input class="aa-cart-quantity" type="number" name="${item.product.id}" value="${item.qty}" min="1" max="${item.product.inventory}"></td>
