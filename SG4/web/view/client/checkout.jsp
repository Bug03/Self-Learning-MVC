            ...
            <div class="col-md-12">
                <div class="checkout-area">
                    <form action="${pageContext.request.contextPath}/view/client/transaction" method="post">
                        <div class="row">
                            <c:if test="${sessionScope.username == null && sessionScope.order != null &&  sessionScope.length_order != 0}">
                                <p class="aa-checkout-error"><i class="fas fa-user-circle"></i> Bạn cần đăng nhập để thanh toán! Đăng nhập <a href="${pageContext.request.contextPath}/view/client/login" style="color: rgb(28 216 254)">tại đây!</a></p>
                            </c:if>
                            <c:if test="${sessionScope.order == null || sessionScope.length_order == 0}">
                                <p class="aa-checkout-error"><i class="fas fa-shopping-cart"></i> Giỏ hàng của bạn đang trống ! Mua hàng <a href="${pageContext.request.contextPath}/view/client/product" style="color: rgb(28 216 254)">tại đây!</a></p>
                            </c:if>
                            <div class="col-md-6">
                                                ...
                                                <div id="collapseFour">
                                                    <div class="panel-body">
                                                        <div class="row">
                                                            <div class="col-md-12">
                                                                <div class="aa-checkout-single-bill">
                                                                    <input type="text" placeholder="Họ Tên*" required="required" name="transaction_name" value="${user.name}">
                                                                </div>                             
                                                            </div>
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-6">
                                                                <div class="aa-checkout-single-bill">
                                                                    <input type="email" placeholder="Email*" required="required" name="transaction_email" value="${user.email}">
                                                                </div>                             
                                                            </div>
                                                            <div class="col-md-6">
                                                                <div class="aa-checkout-single-bill">
                                                                    <input type="tel" placeholder="Số điện thoại*" required="required" name="transaction_phone" value="${user.phone}">
                                                                </div>
                                                            </div>
                                                        </div> 
                                                        <div class="row">
                                                            <div class="col-md-12">
                                                                <div class="aa-checkout-single-bill">
                                                                    <select id="address" name="transaction_address">
                                        ...
                                        <div class="aa-order-summary-area">
                                            <table class="table table-responsive">
                                                ...
                                                <tfoot>
                                                    ...
                                                    <tr>
                                                        <th>Tổng cộng</th>
                                                        <td><strong>${sumprice} đ</strong></td>
                                                    </tr>
                                                </tfoot>
                                            </table>
                                        </div>
