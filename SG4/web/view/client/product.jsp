        ...
        <div class="row">
            <div class="col-lg-9 col-md-9 col-sm-8 col-md-push-3">
                ...
                <div class="pagination">
                    ...
                    <c:if test="${tag > 1}">
                        <a href="${pageContext.request.contextPath}/view/client/product?index=${tag - 1}">&laquo;</a>
                    </c:if>

                    <c:forEach begin="${beginP}" end="${maxP}" var="i">
                        <a class="${tag == i?"active" : ""}" href="${pageContext.request.contextPath}/view/client/product?index=${i}">${i}</a>
                    </c:forEach>
                    <c:if test="${tag < maxP}">
                        <a href="${pageContext.request.contextPath}/view/client/product?index=${tag + 1}">&raquo;</a>
                    </c:if>
                </div>
                <!-- /Paging -->
            </div>
