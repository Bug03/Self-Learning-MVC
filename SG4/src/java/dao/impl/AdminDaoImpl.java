...
public class AdminDaoImpl extends connectDB implements AdminDao {
    ...
    public void insert(Admin admin) {
        String sql = "INSERT INTO admin(username,password,name,created) VALUES (?,?,?,?)";
        new connectDB();
        ...
        try {
            ...
            ps.setString(4, admin.getCreated());
            ps.executeUpdate();
    ...
    @Override
    public List<Admin> paging(int index) {
        List<Admin> admins = new ArrayList<>();
        String sql = "SELECT * FROM admin ORDER BY id OFFSET ? ROWS FETCH NEXT 12 ROWS ONLY";
        Connection conn = connectDB.getConnect();
        try {
            PreparedStatement ps = conn.prepareStatement(sql);
